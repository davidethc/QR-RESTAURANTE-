...
create index idx_restaurant_members_role on public.restaurant_members (restaurant_id, role);
...
create index idx_categories_active_position on public.categories (restaurant_id, active, position);
...
create index idx_products_active_position on public.products (restaurant_id, active, position);
...
-- Waiter Calls indexes
create index idx_waiter_calls_restaurant on public.waiter_calls (restaurant_id);
create index idx_waiter_calls_status on public.waiter_calls (restaurant_id, status);
